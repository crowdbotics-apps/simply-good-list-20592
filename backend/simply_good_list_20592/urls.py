"""simply_good_list_20592 URL Configuration
...
admin.site.site_header = "simply good list"
admin.site.site_title = "simply good list Admin Portal"
admin.site.index_title = "simply good list Admin"

# swagger
api_info = openapi.Info(
    title="simply good list API",
    default_version="v1",
    description="API documentation for simply good list App",
)
